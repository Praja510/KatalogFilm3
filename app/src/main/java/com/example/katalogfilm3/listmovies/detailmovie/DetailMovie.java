package com.example.katalogfilm3.listmovies.detailmovie;
...
import com.example.katalogfilm3.databinding.ActivityDetailMovieBinding;
import com.example.katalogfilm3.listmovies.pojo.ResultsItem;
...
public class DetailMovie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Data Diterima " + movieModel.getTitle(), Toast.LENGTH_SHORT).show();
        Log.d("IDN", "Data Diterima : " + movieModel.getTitle());
